...
using CarShop.Blazor.Server.Services;

namespace CarShop.Blazor.Server {
    public partial class CarShopBlazorApplication : BlazorApplication {
        public CarShopBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void CarShopBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
